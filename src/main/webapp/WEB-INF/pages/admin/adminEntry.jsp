...
<head>
    ...
    <link href="../resources/public/css/login.css" rel="stylesheet" type="text/css" />
    <link href="../resources/public/css/login-gray.css" rel="stylesheet" type="text/css" />  <!-- color skin: blue / red / green / dark -->
</head>
<body>
<div id="main">
    <div id="content">
