...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/public/css/gray.css" rel="stylesheet" type="text/css" media="screen"/>
        ...
        <div class="tabs box">
            ...
            <div class="box-content">
                ...
                <div id="gallery">
                    <div class="container-fluid">
                        <div class="row no-margin">
                            <c:forEach items="${imageListBearings}" var="image">
                                <div class="item col-xs-4 col-sm-2">
                                    <a href="/admin/bearings/photos/remove?image=${image}" class="ico ico-delete" style="float: left"></a>
                                    <img class="img-responsive" alt="" src="${pageContext.request.contextPath}/resources/assets/images/products/bearings/industrial/${image}" <a href="${pageContext.request.contextPath}/resources/assets/images/products/bearings/industrial/${image}"/>/>
                ...
                <div id="upload">
                    ...
                    <form class="formBox" method="post" action="/admin/bearings/photos/upload" enctype="multipart/form-data">
