...
<head>
    ...
    <title>Admin. Automated Lines catalog</title>
...
<!-- breadcrumbs -->
      <div class="breadcrumbs">
            <ul>
                ...
                <li class="home">&nbsp; > &nbsp;</li>
                <li class="home"><a href="#">Automated Lines for manufacturer</a></li>
                <li class="home">&nbsp; > &nbsp;</li>
                <li class="home"><a href="#">Automated Lines</a></li>
            </ul>
        </div>
<!--<div class="breadcrumbs">
...
<div class="tabs box">
<ul class="bookmarks">
    <li><a href="#show_lathes">Automated Lines for manufacturer</a></li>
    <li><a href="#upload">Upload automated lines from file</a></li>
    <li><a href="#filters">Delete all automated lines for Manufacturer</a></li>
</ul>
...
<!--              <th>Photo1</th>
            ...
            <tr>
              ...
              <td><a href="/bearings-${lines.url}">${lines.modelEn}</a></td>            
              <td>${lines.manufacturerEn}</td>                             
              <td>${lines.countryEn} </td>
              <td>${lines.length}x${lines.width}</td>
        
              <td class="action">
                <a href="lines_for_manufacturer/${lines.manufacturerEn}/${lines.url}/delete" class="ico ico-delete">Delete</a>
...
<div id="upload">
    <form:form class="formBox" method="post"  action="lines/add"
               enctype="multipart/form-data">

        <fieldset>
            <div class="clearfix file">
                <div class="lab"><label for="textFile">Upload file with line</label></div>
                <div class="con">
...
<div id="filters">
    <form:form class="formBox" method="GET" action="lines_for_manufacturer/deleteall">

        <fieldset>
            <!--Renewing filters means forming new filter parameters according to existing DB with Machines.-->
            <h3 style="color: red; margin-top:10px">It will have deleted all Automated Lines for manufacturers.</h3>
            <!--As a result, you would see <u>relevant</u> filter parameters.<br><br>-->

            <div class="btn-submit">
                <input type="submit" value="Delete all Automated Lines for Manufacturer" class="button"/>
            </div>
        </fieldset>

    </form:form>
</div>
       <a href="/admin/lines/renewFiltersLines"> renew Filters Automated Lines </a>   
</div>
</div>
</div>
<!-- /#content -->
 <%@include file="/WEB-INF/pages/in_admin/in_sidebar_lines.jsp" %>
